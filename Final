...
clear
whiptail  --title "World-Teck STUDIO (TUTO Assistant Gooogle) " --msgbox "\n Bienvenue sur l'assistance d'installation de google sur Raspberry.\n\n\n Information sur les installations :\n\n\n - Configuration des fichiers installation \n - Vérification + mise à jour de Rasbian \n - Trouvé les zones des peripherique à utilité.\n - Configuré les periphérique de sortie et entrée\n - Test du micro + son\n - Configuration de Google Home via Internet\n - Installation de python3\n - Installation du pack de GOOGLE\n - Configuration de l'assitant google\n -Activation des services \n\n\n Niveau de difficulté de l'instalation : Moyen \n\n Version: 5.0 Final " 30 85
whiptail --title "ETAPE 1" --msgbox "Configuration du cloud google via internet\n------------------------------------------\n\n Temps: entre 5 et 15 min \n\n Mode: Full Manuel" 12 78
